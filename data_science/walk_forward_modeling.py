...
Usage:
    ...
    #   Input:  data/working/parsed_permits_by_year.csv
...
When --config is provided, paths are overridden by the county config (see configs/*.py):
    Input:  <county>/data/working/parsed_permits_by_year.csv
    Output: <county>/output/walk_forward/

Input is generated by: src/create_parsed_permits_by_year.py --config <county>
"""
