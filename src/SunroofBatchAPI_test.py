...
def run(
    ...
    with open(csv_output, "a", newline="", encoding="utf-8") as f, requests.Session() as session:
        ...
        f.flush()
    print(f"Done. Wrote {written_this_run} rows to {csv_output}")
